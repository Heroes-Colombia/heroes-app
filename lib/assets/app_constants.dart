...
class AppConstants {
  ...
  final authTexts = {
    ...
    'signupBusinessView': {
      ...
      'identification-card-label': 'Cédula de ciudadanía',
  ...
  final dashBoardTexts = {
    ...
    "allPromotionsView": {
      ...
      "loading-title": "Cargando",
      "error-title": "Error",
      "error-content": "Ocurrió un error al cargar las promociones",
      "error-button": "Reintentar",
      "all-categories": "Todas las categorías",
      "empty-content": "No se encontraron promociones",
    },
    "favouriteView": {
      "title": "Favoritos",
      "loading-title": "Cargando",
  ...
  final businessDashboardTexts = {
    ...
    "ownedBusinessDetailsView": {
      ...
      "address-updated-success": "Dirección actualizada exitosamente",
      "address-updated-error": "Ocurrió un error al actualizar la dirección",
